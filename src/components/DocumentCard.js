  ...
  return (
    <Box marginX={1} marginBottom={2} borderRadius={3} justifyContent="center" alignItems="center">
       ...
       <Pressable 
        ...
        >
        <Box borderRadius="10px" w="320px" h="72px" display="flex" flexDirection="row" alignItems="center" justifyContent="space-around" marginTop="20px"
         _light={{bg: "#FFFFFF", shadowColor: '#aaa',  
          ...
          <Box flexDir="column">
            <Text fontSize={12} textAlign="center" _light={{color: "#70552E"}} _dark={{color: "#FFF9EB"}}>排便量</Text>
